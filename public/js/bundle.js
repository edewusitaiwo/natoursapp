...
const login = async (email, password) => {
  try {
    ...
    if (res.data.status === 'success') {
      (0, _alert.showAlert)('success', 'Login sucessfully');
      window.setTimeout(() => {
        location.assign('/');
      }, 1500);
    }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"../../route/updateSettings.js":[function(require,module,exports) {
"use strict";
...
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("../public/js/alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
// type is either password or data
const updateSettings = async (data, type) => {
  try {
    const url = type === 'password' ? 'http://127.0.0.1:3002/api/v1/users/updateMyPassword' : 'http://127.0.0.1:3002/api/v1/users/updateMe';
    const res = await (0, _axios.default)({
      method: 'PATCH',
      url,
      data
...
},{"axios":"../../node_modules/axios/index.js","../public/js/alert":"alert.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
var _alert = require("./alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
const stripe = Stripe('pk_test_51TrVOQIUh4nAwxM00q7cmlIZ0dK4ejpECA4flnEnwIpAJgLtp536tXIjbgwU0LzExW8nfXjrJE5ovg81tFsGRHKf00TISNWqWM');
const bookTour = async tourId => {
  try {
    // 1) Get checkout session from API
    const session = await (0, _axios.default)("http://127.0.0.1:3002/api/v1/bookings/checkout-session/".concat(tourId));
    console.log(session);
...
var _updateSettings = require("../../route/updateSettings");
